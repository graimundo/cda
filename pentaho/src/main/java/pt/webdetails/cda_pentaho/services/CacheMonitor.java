...
package pt.webdetails.cda_pentaho.services;
...
import pt.webdetails.cda_pentaho.utils.framework.JsonCallHandler;
import pt.webdetails.cda_pentaho.utils.framework.JsonCallHandler.JsonResultFields;
import pt.webdetails.cda_pentaho.utils.framework.JsonCallHandler.ResponseStatus;
...
public class CacheMonitor extends BaseService {
  ...
  /**
   * formerly known as "cached" List queries in cache
   *
   * @return
   */
  ...
  private static class ResultFields extends JsonResultFields {
  ...
  public JSONObject listQueriesInCache( String cdaSettingsId, String dataAccessId ) throws JSONException, IOException {
    ...
    for ( TableCacheKey key : cdaCache.getKeys() ) {
      ...
      if ( !StringUtils.equals( cdaSettingsId, info.getCdaSettingsId() ) ||
        ( dataAccessId != null && !StringUtils
          .equals( dataAccessId, info.getDataAccessId() ) ) ) {//not what we're looking for
        continue;
      }
   ...
   * @throws JSONException
   */
  private static void getOverviewForCdaSettingsId( HashMap<String, HashMap<String, Integer>> cdaMap, JSONArray results,
                                                   String cdaSettingsId ) throws JSONException {
   ...
   * @throws JSONException
   */
  public JSONObject removeQueryFromCache( String serializedCacheKey )
    throws UnsupportedEncodingException, IOException, ClassNotFoundException, JSONException {
