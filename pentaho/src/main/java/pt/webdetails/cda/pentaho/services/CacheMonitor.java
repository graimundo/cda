...
package pt.webdetails.cda.pentaho.services;
...
import pt.webdetails.cda.pentaho.utils.framework.JsonCallHandler;
...
public class CacheMonitor extends BaseService {
  ...
  public JSONObject listQueriesInCache( String cdaSettingsId, String dataAccessId ) throws JSONException, IOException {
    ...
    response.put( ResultFields.STATUS, JsonCallHandler.ResponseStatus.OK );
  ...
  public JSONObject getCacheQueryTable( String encodedCacheKey ) throws JSONException {
    ...
    try {
      ...
      if ( info != null ) {
        ...
        result.put( JsonCallHandler.JsonResultFields.STATUS, JsonCallHandler.ResponseStatus.OK );
      } else {
  ...
  public JSONObject removeQueryFromCache( String serializedCacheKey )
    ...
    if ( success ) {
      result.put( JsonCallHandler.JsonResultFields.STATUS, JsonCallHandler.ResponseStatus.OK );
      result.put( JsonCallHandler.JsonResultFields.RESULT, true );
      return result;
    } else {
